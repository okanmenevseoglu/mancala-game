 ...
 */
@Component
public class PlayerTwoHomePitValidationRule implements MancalaGameRule {

    /**
     * This method validates if the given index doesn't belong to the home pit of player two.
     *
     * @param board    a board
    ...
    public boolean isValidated(Board board, Integer pitIndex) {
        return !Player.isPlayerTwoHomePitIndex(pitIndex);
    }
    ...
    public String getMessage(Board board) {
        return "Invalid move! This pit is the home pit of Player TWO!";
    }
}
